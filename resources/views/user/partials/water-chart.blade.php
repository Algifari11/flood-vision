<div class="bg-white/70 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-slate-200/60 flex flex-col h-full flex-grow relative group w-full">
    ...
    <div id="chartSkeleton" class="absolute inset-0 top-24 bottom-6 left-6 right-6 animate-pulse flex items-end justify-between gap-2 pb-8">
    ...
    <div class="w-full h-full relative opacity-0 transition-opacity duration-500" id="chartContainer">
        <div class="w-full h-full pb-2 min-h-[350px]">
